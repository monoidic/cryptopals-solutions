...
def ff_reverse(a, mod=0x11b):	#TODO: how the fuck am I supposed to do this (infinite loop right now)
  assert type(a) == type(mod) == int
  t, t1 = 1, 0
  r, r1 = a, mod
  while r != 0:
    ...
    r1, r = r, r1 - q * r
    t1, t = t, t1 - q * t
    print(f'q: 0x{q:x}, r: 0x{r:x}, r1: 0x{r1:x}, t: 0x{t:x}, t1: 0x{t1:x}')
  return (r1, t1)
...
def SubBytes(inbytes, reverse=False):	#TODO: do math instead of table lookups?
  assert type(inbytes) == bytes
  box = sbox if not reverse else rsbox
  out = b''
  for i in inbytes:
    out += bytes([box[i]])
  return out
...
sbox = (
	...
	0x54, 0xbb, 0x16) # https://anh.cs.luc.edu/331/code/aes.py
...
rsbox = (
	...
	0x21, 0x0c, 0x7d) # https://anh.cs.luc.edu/331/code/aes.py
